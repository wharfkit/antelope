...
export class Authority extends Struct {
     ...
     */
    sort() {
        this.keys.sort((a, b) => a.key.compare(b.key))
        this.accounts.sort((a, b) => a.permission.compare(b.permission))
        this.waits.sort((a, b) => a.wait_sec.value.cmp(b.wait_sec.value))
    }
}
