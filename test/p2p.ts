...
suite('p2p', function () {
    ...
    const testMessages : Array<{message:P2P.NetMessage['value'], data:Buffer}> = [
        {
            ...
            data: Buffer.from('','hex')
        },{
            ...
            data: Buffer.from('0200000004ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff040300000005ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff05','hex')
        },{
            message: P2P.GoAwayMessage.from({
                reason: 9,
                nodeId: '01ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff01'
           }),
            data: Buffer.from('0901ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff01','hex')
        },{
            ...
            data: Buffer.from('0100000000000000020000000000000003000000000000000400000000000000','hex')
        },{
            ...
            data: Buffer.from('0101ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff010102ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff02','hex')
        },{
    ...
    for (const {message, data} of testMessages) {
        ...
        test(`receive ${vmessage.variantName}`, async function () {
            ...
            client.on('message', (message) => {
                assert.deepEqual(JSON.parse(JSON.stringify(message)), JSON.parse(JSON.stringify(vmessage)));
                called = true;
            });
    ...
    test('heartbeat trigger', async function(){
        ...
        let fireTimeout = ()=>{};
        const setTimeoutMock:P2PClientOptions['setTimeoutImpl'] = (handler:any, timeout?: number | undefined, ...args: any[]) => {
