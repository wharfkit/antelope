...
suite('api v1', function () {
    ...
    test('chain get_table_rows (`eosio` contract, `voters` table, `reserved3` field)', async function () {
        // Type generated by abi2core
        ...
        // This request will fail if UInt64.from(0) is not allowed
        await jungle.v1.chain.get_table_rows({
            code: 'eosio',
            table: 'voters',
            scope: 'eosio',
            type: VoterInfo,
